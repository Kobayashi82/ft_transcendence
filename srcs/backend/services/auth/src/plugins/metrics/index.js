...
// const authMetrics = require("./auth");
...
async function metricsPlugin(fastify, options) {
  ...
  // const auth = authMetrics(promClient, serviceName);
  // const mdb = dbMetrics(promClient, serviceName);
  ...
  // register.registerMetric(auth.loginAttemptsTotal);
  // register.registerMetric(auth.registrationsTotal);
  // register.registerMetric(auth.tokenValidationsTotal);
  // register.registerMetric(auth.twoFactorAuthTotal);
  // register.registerMetric(auth.activeUsersGauge);
  // register.registerMetric(auth.activeSessionsGauge);
  // register.registerMetric(auth.tokenOperationsTotal);
  // register.registerMetric(auth.securityEventsTotal);

  // register.registerMetric(mdb.dbOperationsTotal);
  // register.registerMetric(mdb.dbOperationDuration);
