const translations = {
  ...
  'tournament.error.selectExactlyFourPlayers': 'Please select exactly 4 players for the tournament',
  'tournament.round': 'Round',
  'tournament.final': 'Final',
  'tournament.roundCompleted': 'Round completed',
  'tournament.roundCompletedTitle': 'Match completed!',
  'tournament.firstSemifinalCompleted': 'First semifinal completed. Proceed to the second semifinal.',
  'tournament.secondSemifinalCompleted': 'Second semifinal completed. Proceed to the final.',
  'tournament.semifinalCompleted': 'Semifinal completed. Proceed to the next round.',
  'tournament.finalCompleted': 'The tournament is over! Congratulations to the winner!',
  'tournament.proceedToSecondSemifinal': 'Proceed to second semifinal',
  'tournament.proceedToFinal': 'Proceed to final',
  'tournament.closeTournament': 'Close tournament',
